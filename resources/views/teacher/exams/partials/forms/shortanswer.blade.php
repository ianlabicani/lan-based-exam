<!-- Short Answer Modal Form -->
<div id="shortAnswerQuestionForm" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        ...
        <form action="{{ route('teacher.exams.items.store', $exam->id) }}" method="POST">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-t-xl">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-2xl font-bold">Short Answer Question</h3>
                        <p class="text-indigo-100 text-sm mt-1">Create a question requiring a brief written answer</p>
                    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-lightbulb text-indigo-600 mr-2"></i>Expected Answer (for grading reference) *
                    </label>
                    <textarea name="expected_answer" rows="3" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                        placeholder="Provide key points or keywords expected in the answer..."></textarea>
                    <p class="text-xs text-gray-500 mt-1">This will help you grade answers consistently</p>
                </div>
