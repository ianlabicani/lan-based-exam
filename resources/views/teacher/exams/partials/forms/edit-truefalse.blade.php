<!-- Edit True/False Modal Form -->
<div id="editTrueFalseQuestionForm" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <form id="editTrueFalseForm" action="" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="sticky top-0 bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-t-xl">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-2xl font-bold">Edit True/False Question</h3>
                        <p class="text-indigo-100 text-sm mt-1">Update your binary choice question</p>
                    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="level" id="editTrueFalseLevel">
                        <select disabled
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-check-circle text-indigo-600 mr-2"></i>Answer *
                        </label>
...
function populateEditTrueFalseForm(item) {
    ...
    document.querySelector('#editTrueFalseLevel').value = level;
    document.querySelector('#editTrueFalseQuestionForm select[disabled]').value = level;
