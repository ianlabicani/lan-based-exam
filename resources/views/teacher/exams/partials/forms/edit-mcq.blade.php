            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="level" id="editMcqLevel">
                        <select disabled
...
function populateEditMcqForm(item) {
    ...
    document.querySelector('#editMcqLevel').value = level;
    document.querySelector('#editMcqQuestionForm select[disabled]').value = level;
